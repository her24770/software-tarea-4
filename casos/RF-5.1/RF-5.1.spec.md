...
| Resultado obtenido | No se identificó texto sin traducción para el idioma seleccionado. |
...
| Resultado obtenido | El texto cambió al modificar el idioma de la página, por lo que no está hardcodeado. |
...
| Resultado obtenido | El texto no excedió el tamaño máximo del componente. |
